...
- related fields can be linked by contextified validators example, the built in _sameAs_ validator

### Data nesting

- validators can be nested to match data as deep as necessary.
- parent validator is _$invalid_ when any of its children validators report $invalid state
...
- _validations_ component option - the definition of your validation
- _$v_ structure - object in your viewmodel that holds the validation state
